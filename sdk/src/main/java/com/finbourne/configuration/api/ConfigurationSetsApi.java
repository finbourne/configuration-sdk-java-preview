...
public class ConfigurationSetsApi {
    ...
    public okhttp3.Call addConfigurationToSetCall(String type, String scope, String code, CreateConfigurationItem createConfigurationItem, String userId, final ApiCallback _callback) throws ApiException {
        ...
        localVarHeaderParams.put("X-LUSID-SDK-Version", "0.1.433");
     ...
     */
    public okhttp3.Call checkAccessTokenExistsCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call checkAccessTokenExistsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = checkAccessTokenExistsCall(_callback);
        return localVarCall;
     ...
     */
    public void checkAccessTokenExists() throws ApiException {
     ...
     */
    public ApiResponse<Void> checkAccessTokenExistsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = checkAccessTokenExistsValidateBeforeCall(null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * [BETA] CheckAccessTokenExists: Check the Personal Access Token exists for the current user (asynchronously)
     * 
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call checkAccessTokenExistsAsync(final ApiCallback<Void> _callback) throws ApiException {
    ...
    /**
     * [EARLY ACCESS] DeleteAccessToken: Delete any stored Personal Access Token for the current user (asynchronously)
     * 
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
    ...
    /**
     * [EARLY ACCESS] GenerateAccessToken: Generate a Personal Access Token for the current user and stores it in the me token (asynchronously)
     * 
     * @param action action&#x3D;regenerate &#x3D; Even if an existing parameter exists, forcibly regenerate a new one (deleting the old)  action&#x3D;ensure &#x3D; If no parameter exists, create one. If one does already exist, verify that it is still valid (call a service?), and if so, return it. If it is not still valid, then regenerate a new one.  action&#x3D;default &#x3D; If a parameter exists, return it. If not then create one. If this parameter is not provided, this is the default behaviour. (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * [EARLY ACCESS] GetConfigurationItem: Get the specific configuration item within an existing set (asynchronously)
     * 
     * @param type Whether the configuration set is Personal or Shared (required)
     * @param scope The scope that identifies a configuration set (required)
     * @param code The code that identifies a configuration set (required)
    ...
    /**
     * [EARLY ACCESS] GetConfigurationSet: Get a configuration set, including all the associated metadata. By default secrets will not be revealed (asynchronously)
     * 
     * @param type Whether the configuration set is Personal or Shared (required)
     * @param scope The scope that identifies a configuration set (required)
     * @param code The code that identifies a configuration set (required)
    ...
    /**
     * [EARLY ACCESS] GetSystemConfigurationSets: Get the specified system configuration sets, including all their associated metadata. By default secrets will not be revealed  All users have access to this endpoint (asynchronously)
     * 
     * @param code The code that identifies a system configuration set (required)
     * @param reveal Whether to reveal the secrets (optional)
     * @param _callback The callback to be executed when the API call finishes
