...
public class ApiClient {
    ...
    private String basePath = "https://www.lusid.com/configuration";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.1.273/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://www.lusid.com/configuration
